...
const Home = () => {
  return (
    <>
      <HomeHero />
      <section className="relative py-[140px_120px]">
        <div className="container">
          <div className="row">
            <div className="max-w-full text-left">
              <div className="relative pt-[100px] mb-10">
                <SecTitle
                  className="mb-0 pl-[130px] max-w-[57%] lg:before:left-[60px] before:absolute before:top-1/3 before:-translate-y-1/2 before:left-20 before:h-0.5 before:w-[45px] before:bg-gray-900"
                  title="About me"
                  tagline="<span class='text-primary-600 text-sm'>Ronald Shelton</span> - Award Winning Author"
                />
                <div className="relative w-[57%] z-[1] pl-[130px] my-10">
                  <Button
                    target="_blank"
                ...
                <div className="absolute top-0 right-0 h-[600px] w-[42%] after:absolute after:-bottom-[15px] after:left-1/2 after:-translate-x-1/2 after:w-[30%] after:h-0.5 after:bg-gray-900">
                  <div
                    className="absolute inset-0 bg-cover bg-[top_center] bg-no-repeat"
                    style={{ backgroundImage: `url(${author})` }}
                  />
                </div>
                <div className="relative w-[65%] italic text-lg leading-[1.66em] tracking-wide py-[60px] px-20 bg-primary-100 z-[1] font-gentium">
                  <p className="mb-0">
